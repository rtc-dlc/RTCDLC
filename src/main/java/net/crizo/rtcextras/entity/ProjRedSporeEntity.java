...
public class ProjRedSporeEntity extends net.minecraft.world.entity.projectile.AbstractArrow implements net.minecraft.world.entity.projectile.ItemSupplier {
	...
	public ProjRedSporeEntity(net.minecraft.world.entity.EntityType<? extends ProjRedSporeEntity> type, net.minecraft.world.level.Level world) {
		super(type, world);
	}

	public ProjRedSporeEntity(net.minecraft.world.entity.EntityType<? extends ProjRedSporeEntity> type, double x, double y, double z, net.minecraft.world.level.Level world,
	...
	public ProjRedSporeEntity(net.minecraft.world.entity.EntityType<? extends ProjRedSporeEntity> type, net.minecraft.world.entity.LivingEntity shooter, net.minecraft.world.level.Level world,
			@javax.annotation.Nullable net.minecraft.world.item.ItemStack firedFromWeapon) {
	...
	/* -----------------------
	   Fire helpers
	   ----------------------- */
	public static ProjRedSporeEntity shoot(net.minecraft.world.level.Level world, net.minecraft.world.entity.LivingEntity entity, net.minecraft.util.RandomSource source) {
		return shoot(world, entity, source, 1f, 5, 0);
	}

	public static ProjRedSporeEntity shoot(net.minecraft.world.level.Level world, net.minecraft.world.entity.LivingEntity entity, net.minecraft.util.RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 5, 0);
	}

	public static ProjRedSporeEntity shoot(net.minecraft.world.level.Level world, net.minecraft.world.entity.LivingEntity entity, net.minecraft.util.RandomSource random, float power, double damage, int knockback) {
		ProjRedSporeEntity entityarrow = new ProjRedSporeEntity(net.crizo.rtcextras.init.RtcExtrasModEntities.PROJ_RED_SPORE.get(), entity, world, null);
	...
	public static ProjRedSporeEntity shoot(net.minecraft.world.entity.LivingEntity entity, net.minecraft.world.entity.LivingEntity target) {
		ProjRedSporeEntity entityarrow = new ProjRedSporeEntity(net.crizo.rtcextras.init.RtcExtrasModEntities.PROJ_RED_SPORE.get(), entity, entity.level(), null);
	...
	private static void tryPlantRedShroomling(net.minecraft.world.level.Level level, net.minecraft.world.phys.BlockHitResult hit) {
		...
		if (!spaceClear)
			return;
		net.minecraft.world.level.block.state.BlockState toPlace = net.crizo.rtcextras.init.RtcExtrasModBlocks.RED_VELUTIPE_SHROOMLING.get().defaultBlockState();
