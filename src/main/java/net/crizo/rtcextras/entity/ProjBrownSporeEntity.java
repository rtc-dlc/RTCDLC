...
public class ProjBrownSporeEntity extends net.minecraft.world.entity.projectile.AbstractArrow implements net.minecraft.world.entity.projectile.ItemSupplier {
	public static final net.minecraft.world.item.ItemStack PROJECTILE_ITEM = new net.minecraft.world.item.ItemStack(net.crizo.rtcextras.init.RtcExtrasModItems.RED_SPORE_SINGLET.get());
	...
	public ProjBrownSporeEntity(net.minecraft.world.entity.EntityType<? extends ProjBrownSporeEntity> type, net.minecraft.world.level.Level world) {
		super(type, world);
	}

	public ProjBrownSporeEntity(net.minecraft.world.entity.EntityType<? extends ProjBrownSporeEntity> type, double x, double y, double z, net.minecraft.world.level.Level world,
	...
	public ProjBrownSporeEntity(net.minecraft.world.entity.EntityType<? extends ProjBrownSporeEntity> type, net.minecraft.world.entity.LivingEntity shooter, net.minecraft.world.level.Level world,
			@javax.annotation.Nullable net.minecraft.world.item.ItemStack firedFromWeapon) {
	...
	protected net.minecraft.world.item.ItemStack getDefaultPickupItem() {
		return new net.minecraft.world.item.ItemStack(net.crizo.rtcextras.init.RtcExtrasModItems.RED_SPORE_SINGLET.get());
	}
	...
	/* -----------------------
	   Fire helpers
	   ----------------------- */
	public static ProjBrownSporeEntity shoot(net.minecraft.world.level.Level world, net.minecraft.world.entity.LivingEntity entity, net.minecraft.util.RandomSource source) {
		return shoot(world, entity, source, 1f, 5, 0);
	}

	public static ProjBrownSporeEntity shoot(net.minecraft.world.level.Level world, net.minecraft.world.entity.LivingEntity entity, net.minecraft.util.RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 5, 0);
	}

	public static ProjBrownSporeEntity shoot(net.minecraft.world.level.Level world, net.minecraft.world.entity.LivingEntity entity, net.minecraft.util.RandomSource random, float power, double damage, int knockback) {
		ProjBrownSporeEntity entityarrow = new ProjBrownSporeEntity(net.crizo.rtcextras.init.RtcExtrasModEntities.PROJ_BROWN_SPORE.get(), entity, world, null);
	...
	public static ProjBrownSporeEntity shoot(net.minecraft.world.entity.LivingEntity entity, net.minecraft.world.entity.LivingEntity target) {
		ProjBrownSporeEntity entityarrow = new ProjBrownSporeEntity(net.crizo.rtcextras.init.RtcExtrasModEntities.PROJ_BROWN_SPORE.get(), entity, entity.level(), null);
	...
	private static void tryPlantRedShroomling(net.minecraft.world.level.Level level, net.minecraft.world.phys.BlockHitResult hit) {
		...
		if (!spaceClear)
			return;
		net.minecraft.world.level.block.state.BlockState toPlace = net.crizo.rtcextras.init.RtcExtrasModBlocks.BROWN_VELUTIPE_SHROOMLING.get().defaultBlockState();
