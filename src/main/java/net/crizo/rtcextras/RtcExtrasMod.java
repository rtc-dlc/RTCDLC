...
@Mod("rtc_extras")
public class RtcExtrasMod {
	public static final Logger LOGGER = LogManager.getLogger(RtcExtrasMod.class);
	public static final String MODID = "rtc_extras";

	public RtcExtrasMod(IEventBus modEventBus) {
